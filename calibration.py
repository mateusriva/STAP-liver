...
# observation_dummy = generate_fat_salt_and_pepper_noise(model_dummy, radius=7,amount=0.00001*f, seed=0)
...
nrrd.write("w{}_f{}_observation.nrrd".format(w,f), observation_dummy)
# nrrd.write("calibration_truth.nrrd", model_labelmap)
nrrd.write("w{}_f{}_prediction.nrrd".format(w,f), joined_labelmap)
