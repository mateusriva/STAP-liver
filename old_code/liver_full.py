...
observed_labelmap = LabelMap("super",None,slic(observation_volume.data, n_segments=1000,
                    compactness=0.0001, multichannel=False, sigma=(5,5,1)))
display_overlayed_volume(observation_volume.data, observed_labelmap.data, label_colors=np.random.rand(4000,3))
